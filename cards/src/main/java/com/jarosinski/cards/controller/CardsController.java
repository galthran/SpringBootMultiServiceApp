package com.jarosinski.cards.controller;

import com.jarosinski.cards.constants.CardsConstants;
import com.jarosinski.cards.dto.CardsContactInfoDTO;
import com.jarosinski.cards.dto.CardsDto;
import com.jarosinski.cards.dto.ErrorResponseDto;
import com.jarosinski.cards.dto.ResponseDto;
...
public class CardsController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = CardsConstants.STATUS_500,
    ...
    @Operation(
            ...
            description = "Get Custom env property that is deployed into cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = CardsConstants.STATUS_200,
